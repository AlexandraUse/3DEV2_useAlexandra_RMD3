...
requirejs([
    ...
    this.socket.on("player_broadcast_connected", connecting_screen.onBroadcastClient.bind(this));
    this.socket.on("player_disconnected", connecting_screen.onDisconnectedClient.bind(this));
